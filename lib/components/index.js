        ...
        _search: function _search() {
            ...
            for (var i in this.letterList) {
                for (var j = 0; j < this.letterList[i].length; j++) {
                    if (reg.test(this.letterList[i][j]['SCHOOL_NAME']) || reg.test(this.letterList[i][j]['SCHOOL_FIRST_LETTER']) || reg.test(this.letterList[i][j]['SCHOOL_SPELL'])) {
